...
m4_define(intSqWB, 20.0)
m4_define(intSqWT, 20.0)
m4_define(intSqH, 65.0)

m4_define(intSqWN, 20)
m4_define(intSqHN, 65)


//dimensions of internal cylinder
m4_define(intCyRB, 25.0)
m4_define(intCyRT, 25.0)
m4_define(intCyH, 65.0)


//dimensions of external square
m4_define(extSqWB, 76.0)
m4_define(extSqLB, 112.0)
m4_define(extSqWT, 76.0)
m4_define(extSqLT, 112.0)
m4_define(extSqH, 65.0)

m4_define(extSqWN, 20)
m4_define(extSqHN, 65)
...
(
  ...
  //-External square
    hex (intCyB0 intCyB3 intCyT3 intCyT0 extSqB0 extSqB3 extSqT3 extSqT0) brick (extSqWN extSqHN extSqWN) simpleGrading (1 1 1)
    hex (intCyB3 intCyB2 intCyT2 intCyT3 extSqB3 extSqB2 extSqT2 extSqT3) brick (extSqWN extSqHN extSqWN) simpleGrading (1 1 1)
    hex (intCyB2 intCyB1 intCyT1 intCyT2 extSqB2 extSqB1 extSqT1 extSqT2) brick (extSqWN extSqHN extSqWN) simpleGrading (1 1 1)
    hex (intCyB1 intCyB0 intCyT0 intCyT1 extSqB1 extSqB0 extSqT0 extSqT1) brick (extSqWN extSqHN extSqWN) simpleGrading (1 1 1)
);
