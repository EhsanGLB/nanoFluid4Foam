...
m4_define(IntSqWB, 2.0)
m4_define(IntSqLB, 1.0)

//width of top
m4_define(IntSqWT, 2.0)
m4_define(IntSqLT, 1.0)
...
(
  //-rectangular
    ...
    (    calc(IntSqWB/2)    calc(-1*IntSqH/2)    calc(-1*IntSqLB/2)    ) vlabel(IntSqB0)
    (    calc(IntSqWB/2)    calc(-1*IntSqH/2)    calc(IntSqLB/2)    ) vlabel(IntSqB1)
    (    calc(-1*IntSqWB/2)    calc(-1*IntSqH/2)    calc(IntSqLB/2)    ) vlabel(IntSqB2)
    (    calc(-1*IntSqWB/2)    calc(-1*IntSqH/2)    calc(-1*IntSqLB/2)    ) vlabel(IntSqB3)

    //-Top of rectangular
    (    calc(IntSqWT/2)    calc(IntSqH/2)    calc(-1*IntSqLT/2)    ) vlabel(IntSqT0)
    (    calc(IntSqWT/2)    calc(IntSqH/2)    calc(IntSqLT/2)    ) vlabel(IntSqT1)
    (    calc(-1*IntSqWT/2)    calc(IntSqH/2)    calc(IntSqLT/2)    ) vlabel(IntSqT2)
    (    calc(-1*IntSqWT/2)    calc(IntSqH/2)    calc(-1*IntSqLT/2)    ) vlabel(IntSqT3)
...
(
    ...
    rectangular
    {
        ...
        (
            //(IntSqB0 IntSqB1 IntSqB2 IntSqB3)
            (IntSqT0 IntSqT1 IntSqB1 IntSqB0)
            (IntSqT1 IntSqT2 IntSqB2 IntSqB1)
            (IntSqT2 IntSqT3 IntSqB3 IntSqB2)
            (IntSqT3 IntSqT0 IntSqB0 IntSqB3)
        );
    }
);
