...
(
  //-Internal square
    hex (intSqB1 intSqB2 intSqT2 intSqT1 intSqB0 intSqB3 intSqT3 intSqT0) fluid (intSqWN intSqHN intSqWN) simpleGrading (1 1 1)

  //-Internal cylinder
    hex (intSqB0 intSqB3 intSqT3 intSqT0 intCyB0 intCyB3 intCyT3 intCyT0) fluid (intSqWN intSqHN intSqWN) simpleGrading (1 1 1)
    hex (intSqB3 intSqB2 intSqT2 intSqT3 intCyB3 intCyB2 intCyT2 intCyT3) fluid (intSqWN intSqHN intSqWN) simpleGrading (1 1 1)
    hex (intSqB2 intSqB1 intSqT1 intSqT2 intCyB2 intCyB1 intCyT1 intCyT2) fluid (intSqWN intSqHN intSqWN) simpleGrading (1 1 1)
    hex (intSqB1 intSqB0 intSqT0 intSqT1 intCyB1 intCyB0 intCyT0 intCyT1) fluid (intSqWN intSqHN intSqWN) simpleGrading (1 1 1)

  //-External cylinder
    hex (intCyB0 intCyB3 intCyT3 intCyT0 extCyB0 extCyB3 extCyT3 extCyT0) solid (extCyRN extCyHN extCyRN) simpleGrading (1 1 1)
    hex (intCyB3 intCyB2 intCyT2 intCyT3 extCyB3 extCyB2 extCyT2 extCyT3) solid (extCyRN extCyHN extCyRN) simpleGrading (1 1 1)
    hex (intCyB2 intCyB1 intCyT1 intCyT2 extCyB2 extCyB1 extCyT1 extCyT2) solid (extCyRN extCyHN extCyRN) simpleGrading (1 1 1)
    hex (intCyB1 intCyB0 intCyT0 intCyT1 extCyB1 extCyB0 extCyT0 extCyT1) solid (extCyRN extCyHN extCyRN) simpleGrading (1 1 1)
);
