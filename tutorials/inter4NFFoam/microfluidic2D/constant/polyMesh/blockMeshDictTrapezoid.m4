...
//variables
m4_define(width, 1600)
m4_define(distance, 100)
m4_define(widthu, 50)
m4_define(widthr, calc(width-distance-widthu))
m4_define(height, 100)
m4_define(heightu, 100)
m4_define(length, 30)
...
(
    ...
    hex (Bl2 Br3 Bu0 Bu1 Fl2 Fr3 Fu0 Fu1) (calc(2*widthu/delta_x) calc(0.5*heightu/delta_y) numberOfCell_z) simpleGrading (1 1 1)//upperChannel
);
