...
#include "parabolicRadialVelocityWaveformBC4NF.H"
...
parabolicRadialVelocityWaveformBC4NF::parabolicRadialVelocityWaveformBC4NF
(
    const fvPatch& p,
...
parabolicRadialVelocityWaveformBC4NF::parabolicRadialVelocityWaveformBC4NF
(
    const parabolicRadialVelocityWaveformBC4NF& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
parabolicRadialVelocityWaveformBC4NF::parabolicRadialVelocityWaveformBC4NF
(
    const parabolicRadialVelocityWaveformBC4NF& fcvpvf,
    const DimensionedField<vector, volMesh>& iF
)
:
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
Foam::scalar Foam::parabolicRadialVelocityWaveformBC4NF::velocityRealFunction(scalar t)
{
...
Foam::complex Foam::parabolicRadialVelocityWaveformBC4NF::velocityComplexFunction(scalar t)
{
    scalar omega_ = 2.0*mathematicalConstant::pi*frequency_;
    int n_ = 1;
...
Foam::scalar Foam::parabolicRadialVelocityWaveformBC4NF::velocityFunction(scalar t)
{
    scalar f_ = 0.0;
    if (fourierSeriesType_ == "real")
    {
...
void parabolicRadialVelocityWaveformBC4NF::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    vectorField::operator=(lenDir_*2.0*velocityFunction(t_)*(1.0 - pow(rp_/radius_, 2.0)));
    fixedValueFvPatchVectorField::updateCoeffs();
}


// Write
void parabolicRadialVelocityWaveformBC4NF::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchVectorField, parabolicRadialVelocityWaveformBC4NF);
