...
#include "womersleyRadialVelocityWaveformBC4NF.H"
...
womersleyRadialVelocityWaveformBC4NF::womersleyRadialVelocityWaveformBC4NF
(
    const fvPatch& p,
...
womersleyRadialVelocityWaveformBC4NF::womersleyRadialVelocityWaveformBC4NF
(
    const womersleyRadialVelocityWaveformBC4NF& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
womersleyRadialVelocityWaveformBC4NF::womersleyRadialVelocityWaveformBC4NF
(
    const womersleyRadialVelocityWaveformBC4NF& fcvpvf,
    const DimensionedField<vector, volMesh>& iF
)
:
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
Foam::scalar Foam::womersleyRadialVelocityWaveformBC4NF::velocityRealFunction(scalar t)
{
...
Foam::complex Foam::womersleyRadialVelocityWaveformBC4NF::velocityComplexFunction(scalar t)
{
    scalar omega_ = 2.0*mathematicalConstant::pi*frequency_;
    int n_ = 1;
...
Foam::scalar Foam::womersleyRadialVelocityWaveformBC4NF::velocityFunction(scalar t)
{
    scalar f_ = 0.0;
    if (fourierSeriesType_ == "real")
    {
...
Foam::complex Foam::womersleyRadialVelocityWaveformBC4NF::radialVelocityFunction(scalar t, scalar r)
{
    scalar re0_(0.0);
    if (fourierSeriesType_ == "real")
    {
...
Foam::complex Foam::womersleyRadialVelocityWaveformBC4NF::velocityAverage()
{
...
void womersleyRadialVelocityWaveformBC4NF::updateCoeffs()
{
    if (updated())
    {
        return;
...
// Write
void womersleyRadialVelocityWaveformBC4NF::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchVectorField, womersleyRadialVelocityWaveformBC4NF);
