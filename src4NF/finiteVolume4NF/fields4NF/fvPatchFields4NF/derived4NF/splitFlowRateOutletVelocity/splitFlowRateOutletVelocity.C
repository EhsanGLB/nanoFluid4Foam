...
#include "splitFlowRateOutletVelocity.H"
#include "volFields.H"
#include "one.H"
...
splitFlowRateOutletVelocity
(
    const splitFlowRateOutletVelocity& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
void Foam::splitFlowRateOutletVelocity::updateValues
(
...
void Foam::splitFlowRateOutletVelocity::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::splitFlowRateOutletVelocity::write(Ostream& os) const
{
