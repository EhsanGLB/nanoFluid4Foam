...
#include "uniformVelocityWaveformBC4NF.H"
...
uniformVelocityWaveformBC4NF::uniformVelocityWaveformBC4NF
(
    const fvPatch& p,
...
uniformVelocityWaveformBC4NF::uniformVelocityWaveformBC4NF
(
    const uniformVelocityWaveformBC4NF& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
uniformVelocityWaveformBC4NF::uniformVelocityWaveformBC4NF
(
    const uniformVelocityWaveformBC4NF& fcvpvf,
    const DimensionedField<vector, volMesh>& iF
)
:
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
Foam::scalar Foam::uniformVelocityWaveformBC4NF::velocityRealFunction(scalar t)
{
...
Foam::complex Foam::uniformVelocityWaveformBC4NF::velocityComplexFunction(scalar t)
{
    scalar omega_ = 2.0*mathematicalConstant::pi*frequency_;
    int n_ = 1;
...
Foam::scalar Foam::uniformVelocityWaveformBC4NF::velocityFunction(scalar t)
{
    scalar f_ = 0.0;
    if (fourierSeriesType_ == "real")
    {
...
void uniformVelocityWaveformBC4NF::updateCoeffs()
{
    if (updated())
    {
        return;
...
// Write
void uniformVelocityWaveformBC4NF::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchVectorField, uniformVelocityWaveformBC4NF);
