...
autoPtr<hybridThermalConductivityModel> hybridThermalConductivityModel::New
(
...
{
    word hybridThermalConductivityModelTypeName(nanoFluidPropertiesDict.lookup("thermalConductivityModel"));

    Info<< "Selecting thermalConductivity model "
        << hybridThermalConductivityModelTypeName << endl;

    dictionaryConstructorTable::iterator cstrIter =
        dictionaryConstructorTablePtr_->find(hybridThermalConductivityModelTypeName);
    ...
    if (cstrIter == dictionaryConstructorTablePtr_->end())
    {
	    ...
	    "const volScalarField&, "
            ...
            << hybridThermalConductivityModelTypeName << endl << endl
            << "Valid  thermalConductivityModels are : " << endl
            << dictionaryConstructorTablePtr_->sortedToc()
            << exit(FatalError);
    }

    return autoPtr<hybridThermalConductivityModel>
