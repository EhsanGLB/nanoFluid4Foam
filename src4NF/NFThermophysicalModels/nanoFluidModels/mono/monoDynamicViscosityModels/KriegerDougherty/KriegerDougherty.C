...
namespace monoDynamicViscosityModels
{
    ...
    addToRunTimeSelectionTable(monoDynamicViscosityModel, KriegerDougherty, dictionary);
...
:
    ...
    alpham_(KriegerDoughertyCoeffs_.lookup("alpham")),
    etha_(readScalar(KriegerDoughertyCoeffs_.lookup("etha")))
{}
...
const volScalarField KriegerDougherty::mu() const
{
    ...
    mu_ = pow( ( 1 - alpha_ / alpham_ ) , ( -etha_ * alpham_ ) ) * mubf_;
