...
Foam::robin4NFFoam::robin4NFFoam
(
    const fvPatch& p,
...
Foam::scalar Foam::robin4NFFoam::qoFunction(scalar t)
{
    int n_ = 0;
    scalar f_ = 0.0;
...
Foam::scalar Foam::robin4NFFoam::hoFunction(scalar t)
{
    int n_ = 0;
    scalar f_ = 0.0;
...
Foam::scalar Foam::robin4NFFoam::ToFunction(scalar t)
{
    int n_ = 0;
    scalar f_ = 0.0;
...
void Foam::robin4NFFoam::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::robin4NFFoam::write(Ostream& os) const
{
