...
#include "powerLawRadialVelocity4NFFoam.H"
...
powerLawRadialVelocity4NFFoam::powerLawRadialVelocity4NFFoam
(
    const fvPatch& p,
...
powerLawRadialVelocity4NFFoam::powerLawRadialVelocity4NFFoam
(
    const powerLawRadialVelocity4NFFoam& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
powerLawRadialVelocity4NFFoam::powerLawRadialVelocity4NFFoam
(
    const powerLawRadialVelocity4NFFoam& fcvpvf,
    const DimensionedField<vector, volMesh>& iF
)
:
...
Foam::scalar Foam::powerLawRadialVelocity4NFFoam::VmFunction(scalar t)
{
    int n_ = 0;
    scalar f_ = 0.0;
...
void powerLawRadialVelocity4NFFoam::updateCoeffs()
{
    if (updated())
    {
        return;
...
// Write
void powerLawRadialVelocity4NFFoam::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchVectorField, powerLawRadialVelocity4NFFoam);
