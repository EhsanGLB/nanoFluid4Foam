...
Foam::photovoltaic4NFFoam::photovoltaic4NFFoam
(
    const fvPatch& p,
...
Foam::scalar Foam::photovoltaic4NFFoam::qoFunction(scalar t)
{
    int n_ = 0;
    scalar f_ = 0.0;
...
Foam::scalar Foam::photovoltaic4NFFoam::hoFunction(scalar t)
{
    int n_ = 0;
    scalar f_ = 0.0;
...
Foam::scalar Foam::photovoltaic4NFFoam::ToFunction(scalar t)
{
    int n_ = 0;
    scalar f_ = 0.0;
...
Foam::scalar Foam::photovoltaic4NFFoam::etaPV(scalar TAvg)
{
    return etaRef_*(1-betaRef_*(TAvg-TRef_));
}


void Foam::photovoltaic4NFFoam::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    gradient() = (absorptivity_*qoFunction(t_)*(1.0-etaPV(TAvg_)) - sigmaSF_*emissivity_*(pow(Tp, 4.0) - pow(ToFunction(t_), 4.0)) - hoFunction(t_)*(Tp-ToFunction(t_)))/kappap;
    fixedGradientFvPatchScalarField::updateCoeffs();
}


void Foam::photovoltaic4NFFoam::write(Ostream& os) const
{
