...
#include "parabolicCollector4NFFoam.H"
...
Foam::parabolicCollector4NFFoam::parabolicCollector4NFFoam
(
    const fvPatch& p,
...
Foam::parabolicCollector4NFFoam::parabolicCollector4NFFoam
(
    const parabolicCollector4NFFoam& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
Foam::scalar Foam::parabolicCollector4NFFoam::qoFunction(scalar t)
{
    int n_ = 0;
    scalar f_ = 0.0;
...
Foam::scalar Foam::parabolicCollector4NFFoam::hoFunction(scalar t)
{
    int n_ = 0;
    scalar f_ = 0.0;
...
Foam::scalar Foam::parabolicCollector4NFFoam::ToFunction(scalar t)
{
    int n_ = 0;
    scalar f_ = 0.0;
...
Foam::scalar Foam::parabolicCollector4NFFoam::LCRFunction(scalar teta)
{
////range coefficients
...
void Foam::parabolicCollector4NFFoam::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::parabolicCollector4NFFoam::write(Ostream& os) const
{
