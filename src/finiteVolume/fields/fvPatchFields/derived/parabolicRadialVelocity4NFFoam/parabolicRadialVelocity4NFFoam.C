...
#include "parabolicRadialVelocity4NFFoam.H"
...
parabolicRadialVelocity4NFFoam::parabolicRadialVelocity4NFFoam
(
    const fvPatch& p,
...
parabolicRadialVelocity4NFFoam::parabolicRadialVelocity4NFFoam
(
    const parabolicRadialVelocity4NFFoam& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
parabolicRadialVelocity4NFFoam::parabolicRadialVelocity4NFFoam
(
    const parabolicRadialVelocity4NFFoam& fcvpvf,
    const DimensionedField<vector, volMesh>& iF
)
:
...
Foam::scalar Foam::parabolicRadialVelocity4NFFoam::VmFunction(scalar t)
{
    int n_ = 0;
    scalar f_ = 0.0;
...
void parabolicRadialVelocity4NFFoam::updateCoeffs()
{
    if (updated())
    {
        return;
...
// Write
void parabolicRadialVelocity4NFFoam::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchVectorField, parabolicRadialVelocity4NFFoam);
