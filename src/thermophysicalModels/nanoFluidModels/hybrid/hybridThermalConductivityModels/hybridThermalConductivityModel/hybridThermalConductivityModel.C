...
namespace Foam
{
    defineTypeNameAndDebug(hybridThermalConductivityModel, 0);
    defineRunTimeSelectionTable(hybridThermalConductivityModel, dictionary);


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::hybridThermalConductivityModel::hybridThermalConductivityModel
(
