...
namespace Foam
{
    defineTypeNameAndDebug(thermophoresisDiffusivityModel, 0);
    defineRunTimeSelectionTable(thermophoresisDiffusivityModel, dictionary);


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::thermophoresisDiffusivityModel::thermophoresisDiffusivityModel
(
