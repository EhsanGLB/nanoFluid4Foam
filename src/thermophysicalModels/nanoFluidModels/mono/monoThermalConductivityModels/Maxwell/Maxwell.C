...
namespace monoThermalConductivityModels
{
    ...
    addToRunTimeSelectionTable(monoThermalConductivityModel, Maxwell, dictionary);
...
:
    ...
    MaxwellCoeffs_(nanoFluidPropertiesDict.subDict(typeName + "Coeffs"))
{}


// * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * * //

const volScalarField Maxwell::kappa() const
{
