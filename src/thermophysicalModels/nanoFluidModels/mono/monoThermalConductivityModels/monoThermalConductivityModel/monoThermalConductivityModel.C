...
namespace Foam
{
    defineTypeNameAndDebug(monoThermalConductivityModel, 0);
    defineRunTimeSelectionTable(monoThermalConductivityModel, dictionary);


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::monoThermalConductivityModel::monoThermalConductivityModel
(
...
:
    ...
    particleModelPtr_(particleModelPtr),
