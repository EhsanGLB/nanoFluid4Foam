...
namespace monoDynamicViscosityModels
{
    ...
    addToRunTimeSelectionTable(monoDynamicViscosityModel, Brinkman, dictionary);
...
:
    ...
    BrinkmanCoeffs_(nanoFluidPropertiesDict.subDict(typeName + "Coeffs"))
{}


// * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * * //

const volScalarField Brinkman::mu() const
{
