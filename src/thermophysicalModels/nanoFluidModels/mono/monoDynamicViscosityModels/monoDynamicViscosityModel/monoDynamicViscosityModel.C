...
namespace Foam
{
    defineTypeNameAndDebug(monoDynamicViscosityModel, 0);
    defineRunTimeSelectionTable(monoDynamicViscosityModel, dictionary);


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::monoDynamicViscosityModel::monoDynamicViscosityModel
(
