...
{
    defineTypeNameAndDebug(Batchelor, 0);
    addToRunTimeSelectionTable(monoDynamicViscosityModel, Batchelor, dictionary);
...
:
    ...
    BatchelorCoeffs_(nanoFluidPropertiesDict.subDict(typeName + "Coeffs"))
{}


// * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * * //

const volScalarField Batchelor::mu() const
{
    ...
    mu_ = ( 1 + 2.5 * alpha_ + 6.5 * pow( alpha_ , 2.0) ) * mubf_;
